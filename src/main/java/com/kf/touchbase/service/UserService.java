...
import com.kf.touchbase.domain.Authority;
import com.kf.touchbase.domain.User;
import com.kf.touchbase.repository.AuthorityRepository;
...
import com.kf.touchbase.service.util.RandomUtil;
import com.kf.touchbase.web.rest.errors.*;
import com.kf.touchbase.security.PasswordEncoder;
...
public class UserService {
    ...
    private void clearUserCaches(User user) {
        ...
        Objects.requireNonNull(cacheManager.getCache(UserRepository.USERS_BY_AUTH_KEY_CACHE)).invalidate(user.getAuthKey());
    }
