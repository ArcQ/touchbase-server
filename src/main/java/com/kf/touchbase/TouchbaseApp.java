...
import com.kf.touchbase.config.DefaultProfileUtil;
...
public class TouchbaseApp {

    private static final Logger log = LoggerFactory.getLogger(TouchbaseApp.class);

    /**
     * Initializes TouchbaseApp.
     * <p>
